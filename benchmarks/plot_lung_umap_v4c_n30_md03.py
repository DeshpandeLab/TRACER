...
OUT_DIR = REPO / "benchmarks" / "lung_full_seq" / "v4c_n30_md03"
OUT_DIR.mkdir(parents=True, exist_ok=True)

MIN_TX = 20
UMAP_NEIGHBORS = 30
UMAP_MIN_DIST = 0.3   # ← only change vs v4
RNG = 42
