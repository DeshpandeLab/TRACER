#!/usr/bin/env python3
"""Lung UMAP v4b: same as v4 (euclidean, no norm, no SVD) but min_dist=0.3.
...
OUT_DIR = REPO / "benchmarks" / "lung_full_seq" / "v4b_eucl_md03"
