#!/usr/bin/env python3
"""Re-plot lung scanpy_recipe_v2 as a 3-panel combined Leiden-colored view.
...
DIR = REPO / "benchmarks" / "lung_full_seq" / "scanpy_recipe_v2"
...
def main() -> int:
    ...
    plt.suptitle("Lung scanpy recipe — Leiden res=1.0 clusters per subset  "
