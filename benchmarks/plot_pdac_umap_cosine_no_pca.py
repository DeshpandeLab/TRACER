...
Outputs in benchmarks/pdac_full_seq/scanpy_cosine_no_pca_res04/.
"""
...
OUT_DIR = REPO / "benchmarks" / "pdac_full_seq" / "scanpy_cosine_no_pca_res04"
...
def _plot_pair(adata, name, out_path):
    ...
    plt.suptitle(f"PDAC scanpy + cosine neighbors (NO PCA), "
                  f"n_neighbors={N_NEIGHBORS}, UMAP min_dist={UMAP_MIN_DIST}, "
