#!/usr/bin/env python3
"""Re-plot lung scanpy_recipe_res03_partial10 as a 3-panel combined Leiden-colored view.
...
DIR = REPO / "benchmarks" / "pdac_full_seq" / "scanpy_recipe_res03_partial10"
...
def main() -> int:
    ...
    plt.suptitle("PDAC scanpy recipe — Leiden res=0.3 clusters per subset  "
